...
| ------------- | ------------- | ------------- |
| `c`  | a+b    | нет символа ($) поэтому присваивается строковое значение |
| `d`  | 1+2    | присваивается значение переменных a и b |
| `e`  | 3      | в конструкции $(()) выполняет арифмитическое действие       и значение присваивается переменной |
